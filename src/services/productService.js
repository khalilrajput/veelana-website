const STORAGE_KEY = 'veelana_products_cms_v3';
...
export const DEFAULT_PRODUCTS = [
  ...
  },
  {
    ...
    subtitle: 'Special Offer: 1 Bottle',
    badge: 'DISCOUNT OFFER • 1 BOTTLE FOR RS. 1,899',
    price: 'Rs. 1,899',
    priceNum: 1899,
    ...
    category: 'bottles',
    features: [
      '200ml Extra Volume Master Bottle',
      'Best Value for 2-3 Months Routine',
      'Deep Follicle Restoration Cycle',
      '26 Botanical Extracts Infusion',
      'Save Rs. 550 on Regular Retail Price',
      'Priority Dispatch & WhatsApp Support'
    ],
    waMessage: 'Hi,%20I%20want%20to%20order%20the%20Veelana%20200ml%20bottle%20(Rs.%201,899)',
    popular: true,
    inStock: true,
  },
  {
    ...
    subtitle: 'Special Deal: 2 Bottles of 200ml',
    badge: 'MEGA OFFER • 2 BOTTLES FOR RS. 3,499 (FREE DELIVERY)',
    price: 'Rs. 3,499',
    priceNum: 3499,
    ...
    features: [
      ...
      'Save Rs. 1,400 Total Discount on 2 Bottles',
      'VIP Priority Customer Support on WhatsApp'
    ],
    waMessage: 'Hi,%20I%20want%20to%20order%20the%20Veelana%20Twin%20Pack%202x%20200ml%20(Rs.%203,499)',
    popular: false,
    inStock: true,
  },
  {
